...
const docs = [
  ...
  {
    name: "decomp(seq,t)",
    description: "`Seq, Int -> List = [Seq, List[Seq]]`<br> \
...

  {
    ...
    description: "`Seq, List[Seq] -> Seq`<br> \
  ...
  },
  {
    ...
    description: "`Part, Int -> Tuple(List[Part])`<br> \
  ...
  {
    name: "char_table(n)",
    description: "`Int -> Dict[(Tuple(Int),Tuple(Int)), Int]`<br> \
  ...
  {
    name: "char_table2(n)",
    description: "`Int -> List[List[Int]]`<br> \
